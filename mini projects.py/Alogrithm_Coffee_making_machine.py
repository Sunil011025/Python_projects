...
eg: Water=200ml Milk=50ml Coffee=75g Money=Rs. 150
...
If user has entered too much money, machine should offer change to the
...
If payment is successful, ingredients to make the selected drink should be deducted from the coffee machine resources. And it will print a message_ Here is your cappuccino." (If cappuccino was their choice)
